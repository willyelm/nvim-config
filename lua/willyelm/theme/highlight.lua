local c = require('willyelm/theme.pallete')
...
highlight.setup = function()
  ...
  hl(0, "MatchParen", { fg = 'NONE', bg = c.match_paren, sp = 'NONE',  })
  ...
  hl(0, "IncSearch", { fg = 'NONE', bg = c.incremental_search_blue })
  ...
  hl(0, "@constructor.javascript", { fg = c.blue, bg = 'NONE', nocombine=true, })
  hl(0, "@variable", { fg = c.parameter, bg = 'NONE' })
  ...
  hl(0, "IlluminatedWordWrite", { fg = 'NONE', bg = c.word_highlight_write })
